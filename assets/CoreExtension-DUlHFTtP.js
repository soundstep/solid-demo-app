...
var Ee = function Ee(s, t, e) {
  return t in s ? Te(s, t, {
    enumerable: !0,
    configurable: !0,
    writable: !0,
    value: e
...
var a = function a(s, t, e) {
  return Ee(s, _typeof(t) != "symbol" ? t + "" : t, e), e;
};
var _e = {
  BASE_URL: "./",
  MODE: "production",
...
function g(s, t) {
  if (!Re() && !s) throw new Error(t || "Assertion failed");
}
function Ye(s, t, e) {
  var r = Math.trunc(s >>> 24),
    ...
    d = Math.trunc(t >>> 8 & 255),
    l = Math.trunc(t & 255),
    f = Math.round(h * e + r * (1 - e)),
    E = Math.round(c * e + n * (1 - e)),
    _ = Math.round(d * e + i * (1 - e)),
    x = Math.round(l * e + o * (1 - e));
  return (f << 24 | E << 16 | _ << 8 | x) >>> 0;
}
function ke(s, t) {
  var e = s >>> 24,
    r = s >>> 16 & 255,
...
var se = /*#__PURE__*/function (_Ae) {
  function se(e) {
    var _this3;
    _classCallCheck(this, se);
    _this3 = _callSuper(this, se);
    ...
    var d = r.system.parameters.MAX_VERTEX_TEXTURE_IMAGE_UNITS,
      l = c.vertex instanceof Function ? c.vertex(d) : c.vertex,
      f = c.fragment instanceof Function ? c.fragment(d) : c.fragment,
      E = Z(n, n.VERTEX_SHADER, l),
      _ = Z(n, n.FRAGMENT_SHADER, f);
    if (!E || !_) throw new Error();
    var x = ge(n, E, _);
    if (!x) throw new Error();
    if (_this3.program = x, i) {
      ...
      if (!(o && i)) {
        if (i) {
          var _ref = e.framebufferDimensions || {},
            h = _ref.width,
            c = _ref.height;
          this.setUniform("u_pixelRatio", 1), this.setUniform("u_resolution", new Float32Array([h !== null && h !== void 0 ? h : 0, c !== null && c !== void 0 ? c : 0]));
...
function Qe(s, t, e) {
  var r = Q(Math.max(s.x1, t.x1), Math.max(s.y1, t.y1), Math.min(s.x2, t.x2), Math.min(s.y2, t.y2), e);
  return r.x1 < r.x2 && r.y1 < r.y2 ? r : Q(0, 0, 0, 0, r);
}
function je(s, t) {
...
var Se = /*#__PURE__*/function (_re2) {
  function Se(e, r) {
    var _this5;
    _classCallCheck(this, Se);
    _this5 = _callSuper(this, Se);
    a(_this5, "fontFamily");
...
var L = /*#__PURE__*/function (_G) {
  function L(e, r) {
    var _this6;
    _classCallCheck(this, L);
    _this6 = _callSuper(this, L, [e]);
    a(_this6, "props");
    _this6.props = L.resolveDefaults(r || {});
    return _this6;
  }
  _inherits(L, _G);
  return _createClass(L, [{
    ...
    key: "makeCacheKey",
    value: function makeCacheKey(e) {
      return "ColorTexture,".concat(L.resolveDefaults(e).color);
    }
  }, {
    key: "resolveDefaults",
    value: function resolveDefaults(e) {
...
a(L, "z$__type__Props");
var Y = L;
var Me = /*#__PURE__*/_createClass(function Me(t, e) {
...
var Ne = /*#__PURE__*/_createClass(function Ne() {
  _classCallCheck(this, Ne);
});
var we = /*#__PURE__*/function (_Ne) {
  function we(e, r, n, i, o, h, c, d, l, f, E, _, x) {
    var _this7;
    _classCallCheck(this, we);
    _this7 = _callSuper(this, we);
    a(_this7, "glw");
    a(_this7, "options");
    a(_this7, "buffers");
    a(_this7, "shader");
    ...
    value: function draw() {
      ...
      if (this.clippingRect.valid) {
        var _this$clippingRect = this.clippingRect,
          ...
          d = _this$clippingRect.y,
          l = _this$clippingRect.width,
          f = _this$clippingRect.height,
          E = i.pixelRatio,
          _ = i.canvas.height,
          x = Math.round(c * E),
          T = Math.round(l * E),
          R = Math.round(f * E),
          A = Math.round(_ - R - d * E);
        e.setScissorTest(!0), e.scissor(x, A, T, R);
...
var j = function j(s) {
  ...
  ne = function ne(s, t, e, r) {
    ...
    return function (l) {
      ...
      var f = .5,
        ...
        x;
      for (var A = 0; A < 20; A++) {
        if (E = f * (f * (f * o + i) + n), x = l - E, x > -1e-8 && x < 1e-8) return f * (f * (f * d + c) + h);
        if (_ = f * (f * (3 * o) + 2 * i) + n, _ > 1e-10 && _ < 1e-10) break;
        f += x / _;
      }
      var T = 0,
        R = 1;
      for (var _A = 0; _A < 20; _A++) {
        if (f = .5 * (T + R), E = f * (f * (f * o + i) + n), x = l - E, x > -1e-8 && x < 1e-8) return f * (f * (f * d + c) + h);
        x < 0 ? R = f : T = f;
      }
    };
  },
  ...
  nt = function nt(s) {
    ...
    return s.startsWith("cubic-bezier") ? Be(s) : (console.warn("Unknown timing function: " + s), U);
  };
  ...
  return _createClass(B, [{
    ...
    value: function () {
      var _onLoadRequest = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee2() {
        var h, e, r, n, i, o, c, _c$, _n$data, _c, _n$data$width, d, _n$data$height, l, f, E, _;
        return _regeneratorRuntime().wrap(function _callee2$(_context2) {
          while (1) switch (_context2.prev = _context2.next) {
            ...
            case 7:
              i = 0, o = 0;
              if (g(this._nativeCtxTexture), e.activeTexture(0), n.data instanceof ImageBitmap || n.data instanceof ImageData || Ue(n.data)) {
                c = n.data;
                i = c.width, o = c.height, e.bindTexture(this._nativeCtxTexture), e.pixelStorei(e.UNPACK_PREMULTIPLY_ALPHA_WEBGL, !!n.premultiplyAlpha), e.texImage2D(0, e.RGBA, e.RGBA, e.UNSIGNED_BYTE, c), r.setTextureMemUse(this, i * o * 4), (e.isWebGl2() || j(i) && j(o)) && e.generateMipmap();
                ...
                _n$data = n.data, _c = _n$data.mipmaps, _n$data$width = _n$data.width, d = _n$data$width === void 0 ? 0 : _n$data$width, _n$data$height = _n$data.height, l = _n$data$height === void 0 ? 0 : _n$data$height, f = _n$data.type, E = _n$data.glInternalFormat, _ = f === "ktx" ? new DataView((_c$ = _c[0]) !== null && _c$ !== void 0 ? _c$ : new ArrayBuffer(0)) : _c[0];
                e.bindTexture(this._nativeCtxTexture), e.compressedTexImage2D(0, E, d, l, 0, _), e.texParameteri(e.TEXTURE_WRAP_S, e.CLAMP_TO_EDGE), e.texParameteri(e.TEXTURE_WRAP_T, e.CLAMP_TO_EDGE), e.texParameteri(e.TEXTURE_MAG_FILTER, e.LINEAR), e.texParameteri(e.TEXTURE_MIN_FILTER, e.LINEAR), r.setTextureMemUse(this, _.byteLength);
...
a(D, "z$__type__Props");
var C = D;
var Ce = /*#__PURE__*/function (_B) {
  function Ce(t, e, r) {
    _classCallCheck(this, Ce);
    return _callSuper(this, Ce, [t, e, r]);
  }
  _inherits(Ce, _B);
...
var Oe = /*#__PURE__*/function () {
  ...
  return _createClass(Oe, [{
    ...
    value: function texImage2D(t, e, r, n, i, o, h, c) {
      var d = this.gl;
      o ? d.texImage2D(d.TEXTURE_2D, t, e, r, n, i, o, h, c) : d.texImage2D(d.TEXTURE_2D, t, e, r, n, i);
    }
  }, {
    ...
    value: function scissor(t, e, r, n) {
      var i = this.gl,
        ...
        h = this.scissorY,
        c = this.scissorWidth,
        d = this.scissorHeight;
      (t !== o || e !== h || r !== c || n !== d) && (i.scissor(t, e, r, n), this.scissorX = t, this.scissorY = e, this.scissorWidth = r, this.scissorHeight = n);
    }
  }, {
    key: "setBlend",
    ...
    value: function vertexAttribPointer(t, e, r, n, i, o, h) {
      var c = this.gl,
        d = this.boundArrayBuffer;
      d !== t && (c.bindBuffer(c.ARRAY_BUFFER, t), this.boundArrayBuffer = t), c.vertexAttribPointer(e, r, n, i, o, h);
    }
  }, {
    key: "useProgram",
    ...
    value: function setUniform(t, e) {
      ...
      (!h || !Ge(h, r)) && (o.set(e, r), n[t].apply(n, [e].concat(r)));
    }
  }, {
    key: "getParameter",
...
a(O, "z$__type__Props");
var k = O;
var ee = /*#__PURE__*/function (_B2) {
  function ee(e, r, n) {
    var _this13;
    _classCallCheck(this, ee);
    _this13 = _callSuper(this, ee, [e, r, n]);
...
var Fe = /*#__PURE__*/function (_be) {
  function Fe(e) {
    ...
    var o = xe(r, e.contextSpy),
      h = _this14.glw = new Oe(o),
      c = pe(n);
    h.viewport(0, 0, r.width, r.height), h.clearColor(c[0], c[1], c[2], c[3]), h.setBlend(!0), h.blendFunc(h.ONE, h.ONE_MINUS_SRC_ALPHA), Pe(h, i), _this14.system = {
      parameters: Le(_this14.glw),
      extensions: ye(_this14.glw)
    ...
    _this14.quadBufferCollection = new De([{
      buffer: d,
      attributes: {
        a_position: {
          name: "a_position",
  ...
  return _createClass(Fe, [{
    ...
    value: function createCtxTexture(e) {
      return e instanceof C ? new Ce(this.glw, this.txMemManager, e) : e instanceof k ? new ee(this.glw, this.txMemManager, e) : new B(this.glw, this.txMemManager, e);
    }
  }, {
    key: "addQuad",
    value: function addQuad(e) {
      var _m, _ref3, _ref4, _ref6, _ref7;
      var r = this.fQuadBuffer,
        ...
        W = e.td,
        ie = e.rtt,
        ae = e.parentHasRenderTexture,
        oe = e.framebufferDimensions;
      var m = e.texture;
      if (_ && V(_, "$dimensions")) {
        var N = _.$dimensions;
        N.width = i, N.height = o;
      }
      m = (_m = m) !== null && _m !== void 0 ? _m : this.defaultTexture, g(m instanceof G, "Invalid texture type");
      ...
      g($ instanceof se), this.reuseRenderOp(e) || (this.newRenderOp($, _, x, he, T, u, ie, ae, oe), w = this.curRenderOp, g(w));
      var ce = (_ref3 = f == null ? void 0 : f.flipX) !== null && _ref3 !== void 0 ? _ref3 : !1,
        ue = (_ref4 = f == null ? void 0 : f.flipY) !== null && _ref4 !== void 0 ? _ref4 : !1;
      var p = 0,
        I = 0,
        M = 1,
        b = 1;
      if (m instanceof C) {
        var _m$props = m.props,
          ...
          de = _m$props.width,
          le = _m$props.height,
          _ref5 = m.parentTexture.dimensions || {
            width: 0,
            height: 0
          },
          _ref5$width = _ref5.width,
          q = _ref5$width === void 0 ? 0 : _ref5$width,
          _ref5$height = _ref5.height,
          K = _ref5$height === void 0 ? 0 : _ref5$height;
        p = _N / q, M = p + de / q, I = y / K, b = I + le / K, m = m.parentTexture;
      }
      ce && (_ref6 = [M, p], p = _ref6[0], M = _ref6[1], _ref6), ue && (_ref7 = [b, I], I = _ref7[0], b = _ref7[1], _ref7);
      var fe = this.stage.txManager,
        z = fe.getCtxTexture(m);
      g(z instanceof B);
      var S = this.addTexture(z, u);
      if (w = this.curRenderOp, g(w), F !== 0 || v !== 0) r[u++] = R, r[u++] = A, r[u++] = p, r[u++] = I, n[u++] = h, r[u++] = S, r[u++] = R + i * X, r[u++] = A + i * v, r[u++] = M, r[u++] = I, n[u++] = c, r[u++] = S, r[u++] = R + o * F, r[u++] = A + o * W, r[u++] = p, r[u++] = b, n[u++] = d, r[u++] = S, r[u++] = R + i * X + o * F, r[u++] = A + i * v + o * W, r[u++] = M, r[u++] = b, n[u++] = l, r[u++] = S;else {
        var _N2 = R + i * X,
          _y = A + o * W;
        r[u++] = R, r[u++] = A, r[u++] = p, r[u++] = I, n[u++] = h, r[u++] = S, r[u++] = _N2, r[u++] = A, r[u++] = M, r[u++] = I, n[u++] = c, r[u++] = S, r[u++] = R, r[u++] = _y, r[u++] = p, r[u++] = b, n[u++] = d, r[u++] = S, r[u++] = _N2, r[u++] = _y, r[u++] = M, r[u++] = b, n[u++] = l, r[u++] = S;
      }
      w.length += Xe, w.numQuads++, this.curBufferIdx = u;
    }
  }, {
    key: "newRenderOp",
    value: function newRenderOp(e, r, n, i, o, h, c, d, l) {
      var f = new we(this.glw, this.options, this.quadBufferCollection, e, r, n, o, i, h, 0, c, d, l);
      this.curRenderOp = f, this.renderOps.push(f);
    }
  }, {
    key: "addTexture",
    value: function addTexture(e, r, n) {
      ...
      if (o === 4294967295) {
        ...
        var h = i.shader,
          ...
          l = i.clippingRect,
          f = i.alpha;
        return this.newRenderOp(h, c, f, d, l, r), this.addTexture(e, r, !0);
      }
      return o;
    }
  }, {
    ...
    value: function reuseRenderOp(e) {
      ...
      return !(((d = this.curRenderOp) == null ? void 0 : d.shader) !== c || !Ie(this.curRenderOp.clippingRect, h) || i || o || this.curRenderOp.shader !== this.defaultShader && (!n || !this.curRenderOp.shader.canBatchShaderProps(this.curRenderOp.shaderProps, n)));
    }
  }, {
    key: "addRenderOp",
    ...
    value: function render() {
      ...
      var r = this.glw,
        ...
        o = (_this$quadBufferColle = this.quadBufferCollection.getBuffer("a_position")) !== null && _this$quadBufferColle !== void 0 ? _this$quadBufferColle : null;
      r.arrayBufferData(o, i, r.STATIC_DRAW), this.renderOps.forEach(function (h, c) {
        h.draw();
      });
    }
  }, {
    ...
    value: function renderRTTNodes() {
      ...
      for (var n = 0; n < this.rttNodes.length; n++) {
        ...
        g(o instanceof ee), this.renderToTextureActive = !0, e.bindFramebuffer(o.framebuffer), e.viewport(0, 0, o.w, o.h), e.clear();
      ...
      return _regeneratorRuntime().wrap(function shapeText$(_context7) {
        while (1) switch (_context7.prev = _context7.next) {
          case 0:
            ...
            d = i !== void 0 ? (((o = this.kernings[c.id]) == null ? void 0 : o[i]) || 0) + e.letterSpacing : 0;
            i = c.id;
            _context7.next = 7;
            return {
              mapped: !0,
...
var it = /*#__PURE__*/function (_Se) {
  function it(e, r, n, i, o, h) {
    var _this16;
    _classCallCheck(this, it);
    _this16 = _callSuper(this, it, [e, r]);
    a(_this16, "type");
    a(_this16, "texture");
    ...
    _this16.type = n;
    var c = i.renderer;
    g(c instanceof Fe, "SDF Font Faces can only be used with the WebGL Renderer"), _this16.texture = i.txManager.loadTexture("ImageTexture", {
      src: o,
      premultiplyAlpha: !1
    }, {
      preload: !0
      ...
      var _ref8 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee7(d) {
        var l;
        return _regeneratorRuntime().wrap(function _callee7$(_context8) {
          while (1) switch (_context8.prev = _context8.next) {
            ...
            case 2:
              ...
              l = 0;
              _this16.data.chars.forEach(function (f) {
                _this16.glyphMap.set(f.id, f);
                var E = f.yoffset + f.height;
                E > l && (l = E);
              }), _this16.maxCharHeight = l, _this16.shaper = new He(_this16.data, _this16.glyphMap), _this16.checkLoaded();
            case 5:
            case "end":
...
var at = /*#__PURE__*/_createClass(function at() {
  _classCallCheck(this, at);
});
export { $e as A, De as B, Ae as C, re as E, k as R, it as S, Se as T, se as W, g as a, pe as b, Q as c, Qe as d, et as e, Ke as f, Ze as g, G as h, Re as i, st as j, je as k, Fe as l, ze as m, Je as n, tt as o, we as p, ke as q, at as r, nt as s, Ye as t, rt as u, Y as v, C as w, Me as x, be as y, qe as z };